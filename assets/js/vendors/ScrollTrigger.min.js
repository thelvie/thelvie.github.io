...
!function(e, t) {
    ...
    function G(r, n) {
        function Yc(e) {
            if (e || 0 === e) {
                ...
                (n || ze.cache !== Yc.cacheID || o("ref")) && (Yc.cacheID = ze.cache,
                Yc.v = r());
    ...
    function K(t, e) {
        ...
        var i = ze.indexOf(t)
          , o = n === Ie.sc ? 1 : 2;
        ~i || (i = ze.push(t) - 1),
        ze[i + o] || t.addEventListener("scroll", F);
        var a = ze[i + o]
    ...
    function P(e) {
        return (Se = e || r()) && "undefined" != typeof document && document.body && (ke = window,
        ...
        Me = T.isTouch = ke.matchMedia && ke.matchMedia("(hover: none), (pointer: coarse)").matches ? 1 : "ontouchstart"in ke || 0 < navigator.maxTouchPoints || 0 < navigator.msMaxTouchPoints ? 2 : 0,
        Re = T.eventTypes = ("ontouchstart"in Ee ? "touchstart,touchmove,touchcancel,touchend" : "onpointerdown"in Ee ? "pointerdown,pointermove,pointercancel,pointerup" : "mousedown,mousemove,mouseup,mouseup").split(","),
        setTimeout(function() {
            return i = 0
        }, 500),
        O(),
    ...
    var Se, Ce, ke, Te, Ee, Pe, Me, Oe, Ae, t, De, Re, Be, i = 1, Ye = [], ze = [], Fe = [], qe = Date.now, o = function _bridge(e, t) {
        return t
    ...
    var T = (Observer.prototype.init = function init(e) {
        ...
        var ee, te, re, ne, ie, oe, ae, se = this, le = 0, ce = 0, ue = K(o, Le), fe = K(o, Ie), pe = ue(), de = fe(), he = ~t.indexOf("touch") && !~t.indexOf("pointer") && "pointerdown" === Re[0], ge = A(o), ve = o.ownerDocument || Te, be = [0, 0, 0], me = [0, 0, 0], ye = 0, xe = se.onPress = function(e) {
    ...
    function yb(e, t, r, n, i, o, a, s) {
        ...
        !g && !s && h || (y += (n === Ie ? k : D) + ":" + (o + parseFloat(f)) + "px;"),
    ...
    function Eb() {
        v && v.isPressed && !(v.startX > Je.clientWidth) || (ze.cache++,
    ...
    var Ne, s, He, Ge, je, Je, l, c, Ve, Ue, Ke, u, Qe, et, f, tt, p, d, h, rt, nt, g, v, b, m, y, E, x, _, it, w, ot, at, st, lt = 1, ct = Date.now, S = ct(), ut = 0, ft = 0, pt = function _isString(e) {
    ...
    }, dt = Math.abs, k = "right", D = "bottom", ht = "width", gt = "height", vt = "Right", bt = "Left", mt = "Top", yt = "Bottom", xt = "padding", _t = "margin", wt = "Width", R = "Height", St = "px", Ct = function _getBounds(e, t) {
        ...
        w = 0
    }, U = ["left", "top", D, k, _t + yt, _t + vt, _t + mt, _t + bt, "display", "flexShrink", "float", "zIndex", "gridColumnStart", "gridColumnEnd", "gridRowStart", "gridRowEnd", "gridArea", "justifySelf", "alignSelf", "placeSelf", "order"], Q = U.concat([ht, gt, "boxSizing", "max" + wt, "max" + R, "position", _t, xt, xt + mt, xt + vt, xt + yt, xt + bt]), Z = /([A-Z])/g, Dt = function _setState(e) {
        if (e) {
            ...
            Ce.refresh = function(e, t, r, n) {
                if (!Qe && Ce.enabled || t)
                    if (ae && e && ut)
                        ...
                        Ce._subPinOffset = !1;
                        var i, o, a, s, l, c, u, f, p, d, h, g, v, b = Te(), m = Ee(), y = pe ? pe.duration() : La(be, ge), x = N <= .01, _ = 0, w = n || 0, S = Qa(r) ? r.end : M.end, C = M.endTrigger || oe, k = Qa(r) ? r.start : M.start || (0 !== M.start && oe ? ae ? "0 0" : "0 100%" : 0), T = Ce.pinnedContainer = M.pinnedContainer && J(M.pinnedContainer, Ce), E = oe && Math.max(0, Et.indexOf(Ce)) || 0, P = E;
                        for (we && Qa(r) && (g = Ne.getProperty(L, ge.p),
                        v = Ne.getProperty(I, ge.p)); P--; )
                            (c = Et[P]).end || c.refresh(0, 1) || (Qe = Ce),
                            !(u = c.pin) || u !== oe && u !== ae && u !== T || c.isReverted || ((d = d || []).unshift(c),
                            c.revert(!0, !0)),
                            c !== Et[P] && (E--,
                            P--);
                        for (Oa(k) && (k = k(Ce)),
                        k = ya(k, "start", Ce),
                        B = fc(k, oe, b, ge, Ae(), F, L, Ce, m, Se, ye, y, pe, Ce._startClamp && "_startClamp") || (ae ? -.001 : 0),
                        Oa(S) && (S = S(Ce)),
                        pt(S) && !S.indexOf("+=") && (~S.indexOf(" ") ? S = (pt(k) ? k.split(" ")[0] : "") + S : (_ = xb(S.substr(2), b),
                        S = pt(k) ? k : (pe ? Ne.utils.mapRange(0, pe.duration(), pe.scrollTrigger.start, pe.scrollTrigger.end, B) : B) + _,
                        C = oe)),
                        S = ya(S, "end", Ce),
                        Y = Math.max(B, fc(S || (C ? "100% 0" : y), C, b, ge, Ae() + _, q, I, Ce, m, Se, ye, y, pe, Ce._endClamp && "_endClamp")) || -.001,
                        _ = 0,
                        P = E; P--; )
                            (u = (c = Et[P]).pin) && c.start - c._pinPush <= B && !pe && 0 < c.end && (i = c.end - (Ce._startClamp ? Math.max(0, c.start) : c.start),
                            (u === oe && c.start - c._pinPush < B || u === T) && isNaN(k) && (_ += i * (1 - c.progress)),
                            u === ae && (w += i));
                        if (B += _,
                        Y += _,
            ...
            Ce.update = function(e, t, r) {
                if (!pe || r || e) {
                    ...
                    p !== d && Ce.enabled) {
                        ...
                        k && (s || ce && p && (p < 1 || !it)) && Ve(k.targets).forEach(function(e) {
    ...
    ScrollTrigger.enable = function enable() {
        ...
        Je)) {
            ...
            E = T.isTouch && /(iPad|iPhone|iPod|Mac)/g.test(navigator.userAgent),
            rb(He, "wheel", Eb),
            l = [He, Ge, je, Je],
    ...
    ee.batch = function(e, t) {
        ...
        for (r in t)
            i[r] = "on" === r.substr(0, 2) && Oa(t[r]) && "onRefreshInit" !== r ? mp(0, t[r]) : t[r];
        return Oa(a) && (a = a(),
    ...
    function nc(e, t) {
        !0 === t ? e.style.removeProperty("touch-action") : e.style.touchAction = !0 === t ? "auto" : t ? "pan-" + t + (T.isTouch ? " pinch-zoom" : "") : "none",
        e === je && nc(Je, t)
    }
    function pc(e) {
    ...
    function uc(e) {
        ...
        var n, o, l, i, a, c, u, s, f = e.normalizeScrollX, t = e.momentum, r = e.allowNestedScroll, p = e.onRelease, d = J(e.target) || je, h = Ne.core.globals().ScrollSmoother, g = h && h.get(), v = E && (e.content && J(e.content) || g && !1 !== e.content && !g.smooth() && g.content()), b = K(d, Ie), m = K(d, Le), y = 1, x = (T.isTouch && He.visualViewport ? He.visualViewport.scale * He.visualViewport.width : He.outerWidth) / He.innerWidth, _ = 0, w = Oa(t) ? function() {
            return t(n)
        }
        : function() {
            return t || 2.8
        }
        , S = qc(d, e.type, !0, r), C = Da, k = Da;
        return v && Ne.set(v, {
            y: "+=0"
        }),
